...
const romania: StoryConfig = {
  ...
  scenes: [
    // COVER
    {
      ...
      dialogue: {
        text: 'The Crow',
        subtext: 'A bedtime story from Romania',
      },
    },
    // ACT 1: THE FAMILIAR
    {
    ...
    },
    {
      ...
      dialogue: {
        text: 'You hold your tooth to the sky and shout: "Take my milk tooth — bring me a STEEL one!" And from the darkness... a shadow appears.',
      },
    },
    // ACT 2: THE QUEST
    {
      ...
      dialogue: {
        ...
        subtext: 'Ancient guardian of the Carpathian Mountains, forger of steel teeth',
      },
    },
    {
      id: 'ro-05',
    ...
    },
    {
      ...
      dialogue: {
        speaker: 'Crow',
        speakerColor: '#9B59B6',
        text: 'By the time I reach the Network, it will be as strong as steel. That is the promise. And I ALWAYS keep my promise.',
      },
    },
    // THE NETWORK
    {
    ...
    // ACT 3: THE INVITATION
    {
      ...
      dialogue: {
        speaker: 'Crow',
        speakerColor: '#9B59B6',
        text: "Other collectors fear the journey. But we ALL make it. A mouse in Spain. A magpie in Korea who SINGS. Your family sees your keepsake — forged strong, kept safe. Each of them adds their own strength. Like iron, it only gets stronger. One day, when you are strong as steel... all that strength comes back to you.",
      },
    },
    {
      id: 'ro-10',
    ...
    // CTA
    {
      ...
      choiceHref: '/toothfairy/app/draw?from=story&slug=romania',
    },
  ],
}
