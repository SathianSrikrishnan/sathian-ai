...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/toothfairy`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/toothfairy/stories`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
  ]
}
