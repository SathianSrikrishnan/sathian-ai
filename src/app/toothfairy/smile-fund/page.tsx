...
export const metadata: Metadata = {
  ...
  description:
    "A parent-controlled Smile Fund helps a child grow from a tooth memory into early lessons about saving, patience, responsibility, and ownership.",
}
...
const timeline = [
  ...
  "Optional family gifts can start the Smile Fund when the payment path is ready.",
  "The child grows into saving, patience, responsibility, and why ownership matters with a parent guiding the pace.",
]

const status = [
  ["Live now", "Memory creation, Google sign-in, public family links, and controlled wallet gift testing."],
    ...
    <main className="smile-page">
      <section className="hero">
        <div className="hero-copy">
          ...
          <h1>A gentle first practice field for saving and responsibility.</h1>
          <p>
            The Smile Fund helps a child see that small gifts can be cared for
            over time. Parents keep the pace gentle while children begin to
            learn patience, saving, responsibility, and why ownership matters.
          </p>
      ...
      <section className="flow">
        <div>
          ...
          <p>
            ...
            without handing a child adult financial control too early.
          </p>
        </div>
        <ol>
      ...
      <section className="resources" aria-label="Parent learning resources">
        <div className="resources-heading">
          ...
          <p>
            ...
            are sober references for saving, small habits, and the risk boundary
            around any grown-up money decision.
          </p>
        </div>
