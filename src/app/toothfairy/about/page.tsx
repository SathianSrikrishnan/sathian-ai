...
export const metadata: Metadata = {
  ...
  description:
    "Tooth Fairy Network helps parents turn a lost tooth into a Toothlight memory, a bedtime story, and a gentle first lesson about care.",
}
...
const momentCards = [
  ...
  },
  {
    ...
    body: "The first Toothlight memory is free to save, so the moment can stay bigger than the night it happened.",
  },
  {
...
const trustCards = [
  ...
  },
  {
    ...
    body: "The Smile Fund is for practice: saving, waiting, generosity, and responsibility in amounts that can stay small.",
  },
  {
    title: "The boundaries are real",
    body: "Tooth Fairy Network is not a bank and this is not investment advice. Card-funded gifts are paused until provider approval, fee disclosures, and parent controls are ready.",
  },
]
    ...
    <main className="about-page">
      <section className="hero">
        <div className="hero-copy">
          ...
          <h1>A lost tooth can teach care before money ever does.</h1>
          <p>
      ...
      <section className="why-section">
        ...
        <div className="why-body">
          ...
          <p>
            ...
            patience, generosity, and what it means to care for something over
            time. Invite grandparents, family, and the closest loved ones into
            that lesson while you keep the controls.
          </p>
        </div>
      </section>
      ...
      <section className="story-band">
        ...
        <div className="story-copy">
          <p className="eyebrow">Tanda and the story world</p>
          <h2>Tanda gives the lesson somewhere to live.</h2>
          <p>
            Tanda introduces children to the keepers of the Tooth Fairy Network,
            so they get bedtime stories instead of lectures. Each character can
            carry a lesson about memory, courage, patience, generosity, and what
      ...
      <section className="smile-section">
        <div className="smile-heading">
          ...
          <h2>It takes a family to make saving feel gentle.</h2>
        </div>
        <div className="smile-body">
          <p>
            The Smile Fund gives small gifts a job. Each gift can become a
            conversation about saving, waiting, generosity, and responsibility.
          </p>
          <p>
