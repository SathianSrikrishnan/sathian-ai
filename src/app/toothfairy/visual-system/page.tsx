...
const slots: Array<{
  ...
  },
  {
    ...
    pageRole: "Make the blockchain folklore idea visually real.",
    ...
    target: "Celestial blockchain organism above homes: fairies and folklore collectors moving through glowing nodes.",
    prompt:
      "Wide cinematic banner showing the Tooth Fairy Network as a celestial blockchain. At night, small fairies and folklore collectors fly between glowing nodes above family homes around the world. A glowing tooth sits at the center like a memory being recorded. Magical, organized, modern, not chaotic. Deep navy sky, fairy gold nodes, subtle Solana teal and restrained purple accents. Leave clean text-safe space on the left.",
    acceptance: [
      "Reads as network/blockchain without looking like a technical diagram.",
