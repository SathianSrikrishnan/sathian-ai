  ...
  return (
    <div className="min-h-screen" style={{ background: C.bg, color: C.text }}>
      ...
      <div className="fixed inset-0 pointer-events-none" style={{
        background: `radial-gradient(ellipse 80% 50% at 50% -20%, ${C.amber}08, transparent)`,
      }} />

      <TfnNav activePage="market" />
        ...
        <div className="space-y-20">
            ...
            <div className="rounded-xl p-8" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={item.family} className="rounded-lg p-4" style={{ background: C.surface }}>
          ...
          <motion.section {...stagger(3)}>
            ...
            <div className="rounded-xl p-8" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
              ...
              {/* The math */}
              <div className="rounded-lg p-6 mb-8" style={{ background: C.surface, border: `1px solid ${C.border}` }}>
