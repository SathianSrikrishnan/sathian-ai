    ...
    <main className={styles.page}>
      ...
      >
        <div className={styles.copy}>
          ...
          <p>
            Your child draws the moment, Magic Studio turns it into a keepsake, and the memory comes first before gifts ever enter the story.
          </p>
        </div>
        ...
        <div className={styles.actions}>
          ...
          <a href="/toothfairy/ritual" className={styles.secondaryAction}>
            See how it works
          </a>
        </div>
      </section>
