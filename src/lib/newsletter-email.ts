...
export function newsletterConfirmation(source: 'sathian-home' | 'tfn-footer') {
    ...
    return {
      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:36px;color:#11234a;background:#fffaf1">
          ...
          <p style="font-size:13px;line-height:1.6;color:#687186">Reply to this email any time if you want to share feedback or leave the list.</p>
        </div>`,
    }
  }
  ...
  return {
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:36px;color:#2b1c13;background:#f6ead3">
        ...
        <p style="font-size:13px;line-height:1.6;color:#6c5843">Reply to this email any time if you want to say hello or leave the list.</p>
      </div>`,
  }
}
