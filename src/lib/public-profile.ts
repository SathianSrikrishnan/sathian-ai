...
export function getPublicProfileMemoryCards(): PublicMemoryCard[] {
  return [
      ...
      .map((release) => releaseToPublicMemoryCard(release)),
    {
      ...
      title: 'Newest featured writing: Saraswati, Lakshmi, and the Ledger',
      body: 'Sathian’s newest featured writing is Saraswati, Lakshmi, and the Ledger. It uses a family mnemonic—two kinds of power—to ask whether AI and crypto deepen human capability and create durable flourishing. Its interactive Saraswati test and Lakshmi test help readers examine a model, product, protocol, company, or policy without treating the result as a universal score. It links the framework to the Solana Observatory, Tooth Fairy Network, Agent Allowance Lab, and the site assistant.',
    ...
    },
    {
      ...
      body: 'Sathian publishes notes on culture, money, technology, fatherhood, and the products he is learning to build. His newest featured essay is Saraswati, Lakshmi, and the Ledger. The writing index is the canonical place to browse the current collection.',
