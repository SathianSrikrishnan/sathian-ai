...
assert(/dpl_8m18RYSwVFocWS8mBRXUCm9Ao3px/.test(plan), 'plan must include the current clean preview deployment id')
assert(/a4a50bd6775ac705b7551cfa6611e56b4fd85c41/.test(plan), 'plan must include the current preview checkpoint commit')
