...
assert(/dpl_A8YB51btAAbcj97dh8fAHuCv4ugC/.test(plan), 'plan must include the current clean preview deployment id')
assert(/ddbe5bc4e1203401ee42341a029d72a373b917b6/.test(plan), 'plan must include the current preview checkpoint commit')
