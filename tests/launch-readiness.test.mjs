...
test("parent-facing copy leads with first forever memory instead of bank language", () => {
  ...
  assert.match(homepage, /first forever memory/i)
  assert.match(homepage, /Magic Studio/i)
  assert.match(homepage, /child draws the moment/i)
  assert.match(homepage, /gifts ever enter the story/i)
  ...
  assert.doesNotMatch(homepage, /Parent-controlled wallet/)
