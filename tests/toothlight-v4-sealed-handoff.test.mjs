...
assert(/Say or type the note/.test(notePanel), 'future note panel must support the voice-first note action')
...
assert(/Next: invite family for a note or gift/.test(notePanel), 'sealed confirmation must use the simplified family next action')
