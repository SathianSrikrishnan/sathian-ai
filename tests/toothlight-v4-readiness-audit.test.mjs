...
for (const text of [
  ...
  'local-ready and build-verified; preview deployed with protected make-page browser proof, family-demo image proof, save-auth boundary proof, and authenticated end-to-end pass pending',
  ...
  'dpl_A8YB51btAAbcj97dh8fAHuCv4ugC',
